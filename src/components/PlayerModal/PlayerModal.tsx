        ...
        >
            ...
            <div className="w-full h-full flex md:flex-col justify-center items-center gap-4">
                <div className="flex md:flex-col gap-4 justify-center items-center text-white md:mt-10">
                    <div className="w-[68px] md:w-[200px] h-[68px] md:h-[200px] bg-red-300 rounded-lg md:rounded-[14px]" />
                    <div className="flex flex-col flex-col-reverse justify-start items-start md:items-center gap-1">
                        ...
                        <span className="text-xs font-bold md:text-2xl md:font-black">
                            Penang Hokkien
                        </span>
                        <span className="text-base font-black md:text-2xl md:font-bold">
                            Episode 1 - The grand title
                        </span>
                    </div>
                </div>
